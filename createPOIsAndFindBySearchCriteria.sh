...
curl -v http://localhost:8000/people -H "Content-Type: application/json" -d '{"name":"thug1", "description":"BLStream Szczecin", "location":{"longitude":124.242, "latitude":145.3535}, "address":{"city":"Szczecin", "street":"Plac Holdu Pruskiego", "zipcode":"70-550", "streetNumber":"9"}, "tags":["friend"]}' -u asd@com:zxc	
curl -v http://localhost:8000/people -H "Content-Type: application/json" -d '{"name":"thug290", "description":"BLStream Szczecin", "location":{"longitude":45.4543, "latitude":143.4342}, "address":{"city":"Szczecin", "street":"Plac Holdu Pruskiego", "zipcode":"70-550", "streetNumber":"9"}, "owner":{"id": "5560babfa1664e30172260d1", "email":"qwe@com", "password":"asd"}, "tags":["grandmother", "teacher"]}' -u qwe@com:asd
